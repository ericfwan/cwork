...
public class topNCapCity_Reg{
    public void run(int top, String reg){
        try {
            // db connection
            ...
            if (con != null) { // connection integrity check
                ...
                System.out.println("Top " +top+ " Cities " +reg+ ":");
                String queryCity = "SELECT * FROM city JOIN country ON city.id = country.capital and country.region = '"+reg+"' ORDER BY city.population DESC LIMIT " +top+ ";";
